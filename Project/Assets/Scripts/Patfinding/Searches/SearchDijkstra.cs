...
public class SearchDijkstra : BaseSearch
{
    public SearchDijkstra(BaseGraph graphValue, Node startNodeValue, Node endNodeValue) : base(graphValue, startNodeValue, endNodeValue)
    { }
